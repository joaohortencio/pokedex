...
export default class Pokemon extends Component {
    ...
    async componentDidMount(){
        ...
        //height is given in decimeters, convert to centimeters
        const height = Math.round(pokemonRes.data.height * 10);
        //weight is given in hectograms, convert to kilos
        ...
        await Axios.get(pokemonSpeciesUrl).then(res => {
          ...
          let evolutionChainUrl = res.data.evolution_chain.url;
          ...
          <div className="col">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="row">
                      ...
                      <div className="col-6">
                        <h6 className="float-left">{this.state.height} Centimeters</h6>
                      </div>
                      <div className="col-6">
                ...
                {(this.state.evolutionChainUrl != "") ? (
                    <div className="row">
                        <PokemonEvolutionChain key={this.state.evolutionChainUrl}
                            evolutionChainUrl={this.state.evolutionChainUrl}
                        />
                    </div>
                ) : null}
              </div>
